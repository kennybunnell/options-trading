...
# Replace lines 1912-end of CC Dashboard in app.py with this code
    ...
    if st.session_state.cc_breakdown:
        ...
        # ===== ACTIVE COVERED CALLS MONITORING PANEL (BOTTOM OF WORKFLOW) =====
        # This panel shows regardless of whether opportunities have been scanned
        st.write("")
        st.write("---")
        st.write("")
        ...
        if active_calls:
            ...
            st.write("Manage your existing covered call positions")
            st.write("")
            ...
            if len(selected_for_buyback) > 0:
                ...
                if dry_run:
                    ...
                    if st.button("🧪 Run Dry Run Test", use_container_width=True, key="cc_buyback_dryrun_btn"):
                        st.write("**🧪 Dry Run Results:**")
                    ...
                    if st.button("🚀 Submit REAL Buy-Back Orders", type="primary", use_container_width=True, key="cc_buyback_live_btn"):
